...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleTicketNotFoundException(TicketNotFoundException ex) {
        log.error("Caught TicketNotFoundException");
    ...
    public ResponseEntity<ErrorDto> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        String errorMessage = fieldErrors.stream()
                ...
                .orElse("Validation error occurred");// for when it's not available
    ...
    public ResponseEntity<ErrorDto> handleConstraintViolation(ConstraintViolationException ex) {
        ...
        errorDto.setError(errorMessage);
        // BAD_REQUEST because the user has provided a request body that doesn't meet requirement
        return new ResponseEntity<>(errorDto, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<ErrorDto> handleException(Exception ex) {
        log.error("Caught exception", ex); // logging in the logs
        ErrorDto errorDto = new ErrorDto();
        // we don't want to leak internal details about the error
